...
class SequentialManager extends Batch {
    ...
    callReporters(result) {
        ...
        if(Array.isArray(this.queueHandler) && Array.isArray(this.queueHandler[1])) {
            functionArguments.push([...queueHandler[1]]);
        }
...
class ParallelManager extends Batch {
    ...
    async addToQueue(batchSet) {
        ...
        if(isPromise) {
            ...
            batchSet
            .then(((queueItemUid, this) => {
                return result => this.handlePromiseSuccess.call(this, result, queueItemUid, 'promise');
            })(queueItemUid, this))
            .catch(((queueItemUid, this) => {
                return err => this.handlePromiseFailure.call(this, err, queueItemUid, 'promise');
            })(queueItemUid, this))
        }
    ...
    setHandlersForQueueItem(batchSet, queueToUse) {
        ...
        .then(((queueItemUid, this, queueToUse) => {
            return result => this.handlePromiseSuccess.call(this, result, queueItemUid, queueToUse);
        })(batchSet.uid, this, queueToUse))
        .catch(((queueItemUid, this, queueToUse) => {
            return err => this.handlePromiseFailure.call(this, err, queueItemUid, queueToUse);
        })(batchSet.uid, this, queueToUse));
    }
...
const batchManager = (options = {unresolvedBatchLimit: 100, mode: modes.sequential, maxRetries: 10}) => {
    switch(options.mode) {
        case modes.parallel:
            return new ParallelManager(options);
        case modes.sequential:
        default:
            return new SequentialManager(options);
    }
}
